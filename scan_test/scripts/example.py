    ...
    def move_robot(self):
        while not self.ctrl_c:
            ...
            if self.state == "wall_right_side":
                if self.right_dist > 0.3 and self.needed_right > 0.08:
...
#
    ...
    def scan_callback(self,data):
        ...
        self.error = self.target - self.right_dist
        
        print("state...", self.state)
        print("Front: ", self.forward_dist)
        print("Right: ", self.right_dist)
